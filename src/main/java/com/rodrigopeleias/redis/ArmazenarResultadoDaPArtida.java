...
public class ArmazenarResultadoDaPArtida {
    ...
    public void realizarPartida(final String jogador1, final String jogador2) {
        ...
        double scoreVencedor = jedis.zincrby(chave, pontosVencedor, vencedor);
        double scorePerdedor = jedis.zincrby(chave, pontosPerdedor, perdedor);

        System.out.println(
                String.format("%s venceu (Score %.0f) | %s perdeu (score: %.0f)",
                        vencedor,
                        scoreVencedor,
                        perdedor,
                        scorePerdedor
    ...
    public static void main(String[] args) {
        ArmazenarResultadoDaPArtida partidas = new ArmazenarResultadoDaPArtida();
